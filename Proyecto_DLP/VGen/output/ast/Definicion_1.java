...
//	definicion_1:bloque -> nombre:String  entero:entero*  tipo:tipo

public class Definicion_1 extends AbstractBloque {

	public Definicion_1(String nombre, List<Entero> entero, Tipo tipo) {
		this.nombre = nombre;
		this.entero = entero;
		this.tipo = tipo;
	...
	public Definicion_1(Object nombre, Object entero, Object tipo) {
