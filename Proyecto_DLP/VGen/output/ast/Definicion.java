...
//	definicion -> nombre:String  entero:entero*  tipo:tipo

public class Definicion extends AbstractAST  {

	public Definicion(String nombre, List<Entero> entero, Tipo tipo) {
		this.nombre = nombre;
		this.entero = entero;
		this.tipo = tipo;
	...
	public Definicion(Object nombre, Object entero, Object tipo) {
