...
//	definicion_2 -> nombre:String  entero:entero*  tipo:tipo

public class Definicion_2 extends AbstractAST  {

	public Definicion_2(String nombre, List<Entero> entero, Tipo tipo) {
		this.nombre = nombre;
		this.entero = entero;
		this.tipo = tipo;
	...
	public Definicion_2(Object nombre, Object entero, Object tipo) {
